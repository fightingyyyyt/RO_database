...
# =========================
# 配置区（保留在前面，便于直接改） 对比第三版 缩写类更偏 LLM-first regex fallback 更严格
...
DEFAULT_OUTPUT_PATH = "./test12/output/5_all.xlsx"  # 输出 Excel 路径
DEFAULT_REPORT_PATH = "./test12/output/5_all.json"  # 输出 JSON 报告路径（可选，不填则不生成）
            ...
            if first_occ:
                ...
                if llm_exp and llm_exp.get("entity_type", "NO_CLUE") != "NO_CLUE":
                    ...
                    if exp_full and exp_type == "SPECIFIC_CHEMICAL":
                        ...
                        if is_trusted_abbreviation_expansion(cleaned, original_name):
