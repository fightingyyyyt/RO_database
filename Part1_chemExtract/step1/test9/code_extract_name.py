...
DEFAULT_OUTPUT_FILE = r"D:\graduate_work\RO_database\Part1_chemExtract\step1\test9\step2_enriched_long.xlsx"
DEFAULT_REPORT_FILE = r"D:\graduate_work\RO_database\Part1_chemExtract\step1\test9\step2_enriched_report.json"
DEFAULT_CHECKPOINT_FILE = r"D:\graduate_work\RO_database\Part1_chemExtract\step1\test9\step2_enriched_checkpoint.csv"
...
def enrich_dataframe_stream(
    ...
    if "RowIndex" not in df.columns or "Original_Name" not in df.columns:
        raise ValueError("Input must include RowIndex and Original_Name")
