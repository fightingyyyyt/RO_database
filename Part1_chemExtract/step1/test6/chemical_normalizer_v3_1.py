...
def main():
    ...
    ap.add_argument("--input", default="./step1//test6/step1.xlsx")
    ap.add_argument("--output", default="./step1/test6/step2.xlsx")
    ap.add_argument("--debug", default="./step1/test6/step2_debug.xlsx")
    ap.add_argument("--failed", default="./step1/test6/step2_failures.xlsx")
    ap.add_argument("--cache", default="./step1/test6/chem_cache.sqlite")
    ap.add_argument("--checkpoint", default="./step1/test6/step2_checkpoint.csv")
